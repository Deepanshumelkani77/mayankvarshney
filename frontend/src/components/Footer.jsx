      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        Your trusted partner for professional financial, taxation, and legal services worldwide. We help businesses and individuals navigate compliance with confidence and ease.
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/919999117576" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#2F6A9E] transition-colors" aria-label="WhatsApp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
