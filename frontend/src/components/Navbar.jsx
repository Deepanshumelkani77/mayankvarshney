      ...
      >
        <div className="max-w-8xl mx-auto h-14 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            <a href="tel:+919999117576" className="flex items-center gap-2 hover:text-[#2F6A9E] transition-colors group" title="Call Us">
              <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
             
            </a>
            <Link to="/contact" className="flex items-center gap-2 hover:text-[#2F6A9E] transition-colors group" title="Email Us">
              <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>

            </Link>
            <a href="https://wa.me/9999117576" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#2F6A9E] transition-colors group" title="WhatsApp">
