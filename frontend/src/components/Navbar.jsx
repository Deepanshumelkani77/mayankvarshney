    ...
    <>
      ...
      >
        <div className="max-w-8xl mx-auto h-14 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-0 bg-white/10 rounded-lg border-2 border-white/10 hover:border-white/80">
            <a href="tel:+919999117576" className="flex items-center gap-2 px-3 py-2  rounded-lg  transition-colors group" title="Call Us">
              <svg className="w-5 h-5 text-yellow-600 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
