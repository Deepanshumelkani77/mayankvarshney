              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Shop No. FF 05, Rise Retailia 1<br />
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:care@mayankvarshney.com" className="text-[#2F6A9E] hover:underline">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+919999117576" className="text-[#2F6A9E] hover:underline">
                    +91 9999117576
                  </a>
                </div>
              </div>
