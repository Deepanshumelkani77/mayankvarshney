    ...
    <div className="bg-[#E5F0E5]">
      ...
      <div className="bg-[#053131] text-white py-4">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 text-center">Get in touch with Mayank Varshney & Co.</p>
        </div>
      </div>

      <div className="max-w-8xl max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 pb-8 ">
        {/* First Row: Form and Map */}
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 px-8">
          <div className="flex items-center justify-between gap-4">
            {/* Address */}
            <div className="flex items-center justify-center space-x-4 flex-3">
              <div className="bg-[#2F6A9E] p-3 rounded-lg flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-base text-gray-600"> Shop No. FF 05, Rise Retailia 1
...
Uttar Pradesh - 201306</p>
            ...
            <div className="flex items-center justify-center space-x-4 flex-1">
              ...
              <div>
                ...
                <a href="mailto:care@mayankvarshney.com" className="text-base text-[#2F6A9E] hover:underline">care@mayankvarshney.com</a>
              </div>
            </div>
            ...
            <div className="flex items-center  justify-center space-x-4 flex-1">
              ...
              <div>
                ...
                <a href="tel:+919910060345" className="text-base text-[#2F6A9E] hover:underline">+91 9999117576</a>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-4 flex-1">
              ...
              <div>
                ...
                <a href="https://wa.me/9999117576" target="_blank" rel="noopener noreferrer" className="text-base text-[#2F6A9E] hover:underline">+91 9999117576</a>
              </div>
            </div>
          </div>
        </div>
