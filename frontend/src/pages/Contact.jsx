          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center justify-center space-x-4 flex-3">
              ...
              <div>
                ...
                <p className="text-base text-gray-600">Shop No. FF 05, Rise Retailia 1, Plot No. SC 01, Sector 1, Greater Noida West, Uttar Pradesh - 201306</p>
              </div>
            </div>
            ...
            <div className="flex items-center  justify-center space-x-4 flex-1">
              ...
              <div>
                ...
                <a href="tel:+919910060345" className="text-base text-[#2F6A9E] hover:underline">+91 99100 60345</a>
              </div>
            </div>
          </div>
        </div>
